...
int main() {
	...
	edges.push_back({0,7,1});
	edges.push_back({7,1,1});
	edges.push_back({0,8,1});
	edges.push_back({8,2,1});
	edges.push_back({0,9,1});
	edges.push_back({9,2,1});
	Graph G(edges,10,2);
	
	std::cout << oddPath(G,allPaths1,allPathsCanon1) << "\n";
